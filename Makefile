...
SHARED_OBJS = shared/registry.o shared/widestring.o shared/debug.o
...
xCreate.far-plug-mb: $(SHARED_OBJS) $(XCREATE_OBJS)
	$(LD) $(LDFLAGS) $^ -o $@
...
clean:
	rm $(SHARED_OBJS) $(XCREATE_OBJS) $(XSCL_OBJS) $(XTRD_OBJS) $(TARGETS)
